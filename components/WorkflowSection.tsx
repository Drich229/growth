    ...
    <section className="w-full bg-[var(--color-bg-secondary)] py-[100px]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center lg:mr-95 mb-12 w-[300px] md:w-[600px] sm:w-[600px] mx-auto">
          ...
          <div className='mx-auto text-center'>
            <p style={{
              ...
              fontWeight: 500,
              lineHeight: '29px',
            }} className="lg:ml-10 lg:h-[58px] mt-4 lg:w-[661px] md:text-xl text-[var(--color-text-work)] ">
        ...
        <div className="text-center">
          <button className="py-[12px] h-[50px] w-[325px] rounded-[16px] bg-[var(--color-primary)] text-white text-center justify-center font-bold transition hover:brightness-110">
