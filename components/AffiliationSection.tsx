    ...
    <section className="w-full py-[100px] bg-[var(--color-bg-secondary)]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="lg:text-[48px] text-[30px] font-bold text-[var(--color-text)] mb-4">
          ...
          <div className="rounded-[16px] w-full md:w-[315px] mx-auto max-w-[315px] h-[520px] bg-[var(--color-card-bg)] border-2 border-[var(--color-border)] p-3 flex flex-col">
            ...
            <div className='border-[var(--color-border)] h-[239px] w-[291px] bg-white border-2 rounded-2xl mb-6'>
              ...
              <div className="space-y-3 mb-auto pb-20">
                ...
                <button className="w-[270px] h-[40px] py-3 px-2 mx-auto rounded-[14px] border-black text-black text-[12px] font-bold hover:bg-[#F0F5FF] transition flex items-center justify-center gap-2">
                  🔗 Inviter des amis
                </button>
              </div>
            </div>
