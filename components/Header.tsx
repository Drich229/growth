  ...
  return (
    <header className="max-w-[100vw] border-b border-[var(--color-border)] bg-[var(--color-bg)] fixed top-0 left-0 right-0 z-50">
      <nav className="relative h-[68px] px-4 lg:px-6 py-4 flex items-center justify-between">
        <div className="text-[20px] leading-[20px] font-bold lg:absolute lg:right-[1321px] top-[24px] text-[var(--color-text)]">GROWTH</div>

        {/* Desktop Menu */}
        <div className="hidden lg:flex lg:absolute lg:top-[21px] lg:right-[784px] lg:w-[383px] lg:h-[26px] items-center text-[14px] leading-[22px] opacity-100">
        ...
        <div className="hidden lg:flex lg:top-[14px] lg:right-[548px] lg:absolute"><LanguageSelector /></div>
        <div className="hidden lg:flex lg:top-[14px] lg:right-[194px] lg:absolute items-center gap-2">
