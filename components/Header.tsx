...
export function Header() {
  ...
  return (
    <header className="max-w-[100vw] border-b border-[var(--color-border)] bg-[var(--color-bg)] fixed top-0 left-0 right-0 z-50">
      <nav className="relative max-w-[1440px] mx-auto h-[68px] px-4 lg:px-6 py-4 flex items-center justify-between">
        <div className="text-[20px] leading-[20px] font-bold lg:absolute lg:right-[1209px] top-[24px] text-[var(--color-text)] z-10">GROWTH</div>

        {/* Desktop Menu */}
        <div className="hidden lg:flex lg:absolute lg:top-[21px] lg:right-[684px] lg:w-[383px] lg:h-[26px] items-center text-[14px] leading-[22px] opacity-100 z-10">
        ...
        <div className="hidden lg:flex lg:top-[14px] lg:right-[448px] lg:absolute z-10"><LanguageSelector /></div>
        <div className="hidden lg:flex lg:top-[14px] lg:right-[94px] lg:absolute items-center gap-2 z-10">
